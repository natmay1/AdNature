 ...
 * Dependencies:
 *        com.adnature.domain.message.entity.MessageReceiver
 *        com.adnature.domain.message.Criteria.MessageReceiverCriteria
 *        com.adnature.domain.message.repository.MessageReceiverRepository.xml
 *        com.adnature.framework.dao.DynamicQuerySqlBuilder
 * History:
 *     Date                 Modifier             Log
 ...
 * ---------------------------------------------------------------------------------------------------
 */
package com.adnature.domain.message.repository;
...
import com.adnature.domain.message.criteria.MessageReceiverCriteria;
