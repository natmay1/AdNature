...
import com.adnature.framework.code.EnumCodeList.CodeListItem;
...
public enum DropdownDatasourceType implements CodeListItem {
     ...
     * 营销枚举类
     */
    MARKET_PATH("market", "com.adnature.marketing.constants");
    
    /**
     * 流程枚举类
     */
    //WORKFLOW_PATH("workflow", "com.adnature.workflow.constants");
