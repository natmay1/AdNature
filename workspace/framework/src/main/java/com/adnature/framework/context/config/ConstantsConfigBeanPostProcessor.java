package com.adnature.framework.context.config;
...
import com.adnature.framework.context.annotation.ConstantsConfig;

/**
 * 常量资源文件加载器，加载指定的资源文件中的值到Spring环境中。
 * 
 * @author zhirong
 * @see com.adnature.framework.context.annotation.ConstantsConfig
 */
