package com.adnature.por.action;
	...
	@Results({ 
		...
		@Result(name = "MapSearchResults", location = "MapSearchResults.ftl", type = "freemarker"),
	})
	
	public class MapSearchResults extends BaseAction{
		...
		@Action(value="MapSearchResults")
		public String mapresults() throws Exception {
			//sysDate=DateUtils.getCurrentDateTime();
