...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="Soccer.png" alt="Soccer" height="238px" width="274px">
    ...
    <div class="item">
      <img src="Walking.png" alt=Walking height="238px" width="274px">
      <div class="carousel-caption">
        <h3>Walking</h3>
    ...
    <div class="item">
      <img src="Canoeing.png" alt="Canoeing" height="238px" width="274px">
      <div class="carousel-caption">
        <h3>Canoeing</h3>
      </div>
    </div>
